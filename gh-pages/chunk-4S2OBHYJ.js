...
function Lt(n, e, t = new Map(), s = new Map()) {
  let i = [],
    r = [],
    a = -1,
    o = null;
...
var Ps = typeof document > "u" ? null : document.documentElement;
function st(n) {
...
var H = null,
  _t = !1;
function Ms(n) {
  H || ((H = Cs() || {}), (_t = H.style ? "WebkitAppearance" in H.style : !1));
  let e = !0;
  return (
    H.style &&
      !Ns(n) &&
...
function ye(n, e, t) {
  return n.hasOwnProperty("duration") ? n : Rs(n, e, t);
}
function Rs(n, e, t) {
  let s =
  ...
  if (typeof n == "string") {
    let o = n.match(s);
    if (o === null) return e.push(gt(n)), { duration: 0, delay: 0, easing: "" };
    i = Ke(parseFloat(o[1]), o[2]);
    let l = o[3];
...
var qe = new RegExp(`${Kt}\\s*(.+?)\\s*${Ds}`, "g");
function qt(n) {
  let e = [];
  if (typeof n == "string") {
    let t;
    for (; (t = qe.exec(n)); ) e.push(t[1]);
    qe.lastIndex = 0;
  }
  return e;
}
function ne(n, e, t) {
  let s = `${n}`,
    i = s.replace(qe, (r, a) => {
      let o = e[a];
      return o == null && (t.push(Yt(a)), (o = "")), o.toString();
    });
  return i == s ? n : i;
}
var Fs = /-+([a-z0-9])/g;
...
var ce = new Set(["true", "1"]),
  fe = new Set(["false", "0"]);
function vt(n, e) {
  let t = ce.has(n) || fe.has(n),
    s = ce.has(e) || fe.has(e);
  return (i, r) => {
    let a = n == _e || n == i,
      o = e == _e || e == r;
    return (
      !a && t && typeof i == "boolean" && (a = i ? ce.has(n) : fe.has(n)),
      !o && s && typeof r == "boolean" && (o = r ? ce.has(e) : fe.has(e)),
      a && o
    );
  };
}
...
var wt = "",
  Qe = class {
    ...
    build(e, t, s) {
      let i = new $e(t);
      return this._resetContextStyleTimingState(i), O(this, se(e), i);
    }
    ...
    visitTrigger(e, t) {
      let s = (t.queryCount = 0),
        ...
        a = [];
      return (
        e.name.charAt(0) == "@" && t.errors.push(Jt()),
    ...
    visitAnimate(e, t) {
      ...
      if (r.type == E.Keyframes) i = this.visitKeyframes(r, t);
        ...
        if (!a) {
          o = !0;
          let h = {};
          s.easing && (h.easing = s.easing), (a = Ne(h));
        }
          ...
          typeof a != "string" &&
            a.forEach((o, l) => {
              ...
              c &&
                ...
                t.options && Ls(o, t.options, t.errors);
            });
        });
    }
    visitKeyframes(e, t) {
      ...
      let i = 1,
        ...
        c = e.steps.map((b) => {
          let A = this._makeStyleAst(b, t),
            C = A.offset != null ? A.offset : js(A.styles),
            N = 0;
          return (
      ...
      l && t.errors.push(ns()), o && t.errors.push(rs());
    ...
    visitStagger(e, t) {
      t.currentQuery || t.errors.push(os());
      let s =
        e.timings === "full"
...
function Y(n) {
  return (
    n ? ((n = le({}, n)), n.params && (n.params = Us(n.params))) : (n = {}), n
  );
}
function ke(n, e, t) {
  return { duration: n, delay: e, easing: t };
}
function ot(n, e, t, s, i, r, a = null, o = !1) {
  return {
    type: 1,
    element: n,
    keyframes: e,
...
var te = class {
  ...
  Xs = ":leave",
  Zs = new RegExp(Xs, "g");
function lt(n, e, t, s, i, r = new Map(), a = new Map(), o, l, h = []) {
  return new Ve().buildKeyframes(n, e, t, s, i, r, a, o, l, h);
}
var Ve = class {
    ...
    _applyAnimationRefDelays(e, t, s) {
      for (let i of e) {
        ...
        if (r) {
          let a =
            typeof r == "number" ? r : $(ne(r, i?.params ?? {}, t.errors));
          s.delayNextStep(a);
        }
      }
    }
    ...
    visitSequence(e, t) {
      ...
      if (
        ...
        i.previousNode.type == E.Style &&
          (i.currentTimeline.snapshotCurrentStyles(), (i.previousNode = Se));
        let a = $(r.delay);
        i.delayNextStep(a);
      }
      e.steps.length &&
  ...
  Ue = class n {
    ...
    invokeQuery(e, t, s, i, r, a) {
      ...
      return !r && o.length == 0 && a.push(ls(t)), o;
    }
  },
  Ee = class n {
    constructor(e, t, s, i) {
    ...
    setStyles(e, t, s, i) {
      ...
      let r = (i && i.params) || {},
        a = Js(e, this._globalTimelineStyles);
      for (let [o, l] of a) {
        let h = ne(l, r, s);
  ...
  je = class extends Ee {
    ...
    buildKeyframes() {
      ...
      if (this._stretchStartingKeyframe && t) {
        ...
        let h = new Map(e[0]);
        h.set("offset", bt(o)), r.push(h);
        let c = e.length - 1;
        for (let u = 1; u <= c; u++) {
          let _ = new Map(e[u]),
            y = _.get("offset"),
            d = t + y * s;
          _.set("offset", bt(d / a)), r.push(_);
        }
        (s = a), (t = 0), (i = ""), (e = r);
      }
      return ot(
...
function At(n, e, t, s, i, r, a, o, l, h, c, u, _) {
  return {
    type: 0,
    element: n,
    triggerName: e,
...
var De = {},
  Te = class {
    ...
    match(e, t, s, i) {
      return xs(this.ast.matchers, e, t, s, i);
    }
    buildStyles(e, t, s) {
    ...
    build(e, t, s, i, r, a, o, l, h, c) {
      let u = [],
        ...
        C = new Map(),
        N = i === "void",
        Z = { params: Qt(g, _), delay: this.ast.options?.delay },
        K = c ? [] : lt(e, t, this.ast.animation, r, a, d, v, Z, h, u),
        k = 0;
      return (
        K.forEach((D) => {
        ...
        u.length
          ? At(t, this._triggerName, s, i, N, d, v, [], [], A, C, k, u)
          : (K.forEach((D) => {
              let j = D.element,
                J = L(A, j, new Set());
              D.preStyleProps.forEach((W) => J.add(W));
              let ht = L(C, j, new Set());
              D.postStyleProps.forEach((W) => ht.add(W)), j !== t && b.add(j);
            }),
            At(
              t,
              this._triggerName,
...
var Ge = class {
  constructor(e, t, s) {
    (this.name = e),
      ...
      Pt(this.states, "true", "1"),
      Pt(this.states, "false", "0"),
...
var si = new te(),
  He = class {
    ...
    _buildPlayer(e, t, s) {
      let i = e.element,
        r = Lt(this._normalizer, e.keyframes, t, s);
          ...
          a &&
            a.forEach((o) => {
              if (o.name == s.triggerName) {
                ...
                (l._data = e), et(s.player, o.phase, l, o.callback);
              }
            }),
            i.markedForDestroy
              ? this._engine.afterFlush(() => {
  ...
  Xe = class {
    ...
    _flushAnimations(e, t) {
      ...
      let u = this.bodyNode,
        ...
        y = kt(_, this.collectedEnterElements),
        d = new Map(),
        g = 0;
      y.forEach((f, m) => {
        let p = it + g++;
      ...
      for (let f = 0; f < this.collectedLeaveElements.length; f++) {
        ...
        p &&
          ...
          b.add(m),
          p.hasAnimation
            ? this.driver.query(m, ai, !0).forEach((T) => b.add(T))
            : A.add(m));
      }
      let C = new Map(),
        N = kt(_, Array.from(b));
        ...
        this._namespaceList[f].drainQueuedTransitions(t).forEach((p) => {
          ...
          w.timelines.forEach((M) => {
            (M.stretchStartingKeyframe = !0),
              this.disabledNodes.has(M.element) || ft.push(M);
          }),
            (w.timelines = ft),
            s.append(P, w.timelines);
          let jt = { instruction: w, player: T, element: P };
          a.push(jt),
            ...
            w.postStyleProps.forEach((M, G) => {
              let F = h.get(G);
              F || h.set(G, (F = new Set())), M.forEach((oe, Pe) => F.add(Pe));
            });
        });
      if (K.length) {
        let f = [];
      ...
      let j = v.filter((f) => Dt(f, l, h)),
        J = new Map();
      Ct(J, this.driver, A, h, B).forEach((f) => {
        Dt(f, l, h) && j.push(f);
      });
      let W = new Map();
      y.forEach((f, m) => {
        Ct(W, this.driver, new Set(f), l, he);
      }),
        j.forEach((f) => {
          let m = J.get(f),
            p = W.get(f);
    ...
    _buildAnimation(e, t, s, i, r, a) {
      let o = t.triggerName,
        ...
        _ = t.timelines.map((d) => {
          ...
          let b = g !== l,
            A = di((s.get(g) || oi).map((k) => k.getRealPlayer())).filter(
              (k) => {
                let D = k;
            ...
            C = r.get(g),
            N = a.get(g),
            Z = Lt(this._normalizer, d.keyframes, C, N),
...
function Ct(n, e, t, s, i) {
  let r = [];
  t.forEach((l) => r.push(Mt(l)));
  let a = [];
  s.forEach((l, h) => {
    let c = new Map();
    l.forEach((u) => {
      let _ = e.computeStyle(h, u, i);
      c.set(u, _), (!_ || _.length == 0) && ((h[z] = li), a.push(h));
    }),
      n.set(h, c);
  });
  let o = 0;
  return t.forEach((l) => Mt(l, r[o++])), a;
}
function kt(n, e) {
  let t = new Map();
...
function Vt(n, e) {
  for (let t = 0; t < n.length; t++) {
    let s = n[t];
    s instanceof Me ? Vt(s.players, e) : e.push(s);
  }
}
function mi(n, e) {
  let t = Object.keys(n),
...
var we = class {
  ...
  Je = class {
    ...
    animate(e, t, s, i, r, a = []) {
      ...
      r && (l.easing = r);
      let h = new Map(),
        c = a.filter((y) => y instanceof we);
      Is(s, i) &&
        c.forEach((y) => {
          y.currentSnapshot.forEach((d, g) => h.set(g, d));
        });
      let u = Os(t).map((y) => new Map(y));
      u = zs(e, u, h);
      let _ = pi(e, u);
      return new we(e, u, l, _);
    }
  };
function Ai(n, e) {
  return n === "noop"
    ? new ve(e, new zt(), new Ie())
    : new ve(e, new Je(), new Be());
}
var Rt = class {
    constructor(e, t) {
      this._driver = e;
    ...
    buildTimelines(e, t, s, i, r) {
      let a = Array.isArray(t) ? Tt(t) : t,
        o = Array.isArray(s) ? Tt(s) : s,
        l = [];
      r = r || new te();
      let h = lt(this._driver, e, this._animationAst, it, pe, a, o, i, r, l);
...
var Ot = class {
  ...
  createRenderer(e, t) {
    ...
    if (!e || !t?.data?.animation) {
      ...
      if (!c) {
        let u = () => h.delete(i);
        (c = new be(s, i, this.engine, u)), h.set(i, c);
      }
      return c;
    }
    let r = t.id,
    ...
    return t.data.animation.forEach(o), new xe(this, a, i, this.engine);
  }
  begin() {
...
export {
  ...
  xe as ɵAnimationRenderer,
  Ot as ɵAnimationRendererFactory,
  ...
  It as ɵinvokeQuery,
  Os as ɵnormalizeKeyframes,
  Ms as ɵvalidateStyleProperty,
  wi as ɵvalidateWebAnimatableStyleProperty,
};
